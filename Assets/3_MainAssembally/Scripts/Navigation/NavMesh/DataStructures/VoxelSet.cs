    ...
    IDictionary<Vector3, T>
{
    ...
    public VoxelSet(VoxelOrientation orientation, params ((int x, int y, int z) index, T value)[] entries)
        : this(orientation, (IEnumerable<((int x, int y, int z) index, T value)>)entries)
    { }

    public VoxelSet(VoxelOrientation orientation, IEnumerable<((int x, int y, int z) index, T value)> entries)
    {
